...
<body id="background-auth" class="font-wars">
    ...
    <div class="flex items-center justify-center">
        <div id="auth-section" class="rounded-lg px-8 py-8">
            {{-- Bagian Konten - Start --}}
            <div class="flex justify-center items-center">
                <img src="{{ asset('assets/img/404pic.png') }}" alt="">
            </div>
            <h1 class="flex-initial w-80 font-semibold text-xl mx-auto text-green-500 py-2">Halaman Tidak Ditemukan!
            </h1>
